...
pub export fn output() void {
    ...
    output_stype();
    if (rflag != 0) {
        write_section(@as([*c][*c]u8, @ptrCast(@alignCast(&tables))));
    }
    write_section(@as([*c][*c]u8, @ptrCast(@alignCast(&header))));
    output_trailing_text();
    write_section(@as([*c][*c]u8, @ptrCast(@alignCast(&body))));
    output_semantic_actions();
    write_section(@as([*c][*c]u8, @ptrCast(@alignCast(&trailer))));
}
...
pub var nvectors: c_int = @import("std").mem.zeroes(c_int);
pub var nentries: c_int = @import("std").mem.zeroes(c_int);
pub var froms: [*c][*c]c_short = @import("std").mem.zeroes([*c][*c]c_short);
pub var tos: [*c][*c]c_short = @import("std").mem.zeroes([*c][*c]c_short);
pub var tally: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var width: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var state_count: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var order: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var base: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var pos: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var maxtable: c_int = @import("std").mem.zeroes(c_int);
pub var table: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var check: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var lowzero: c_int = @import("std").mem.zeroes(c_int);
pub var high: c_int = @import("std").mem.zeroes(c_int);
pub export fn output_prefix() void {
    if (symbol_prefix == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        symbol_prefix = "yy";
    } else {
        outline += 1;
        _ = fprintf(code_file, "#define yyparse %sparse\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yylex %slex\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyerror %serror\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yychar %schar\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyval %sval\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yylval %slval\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yydebug %sdebug\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yynerrs %snerrs\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyerrflag %serrflag\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyss %sss\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yysslim %ssslim\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyssp %sssp\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyvs %svs\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyvsp %svsp\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yystacksize %sstacksize\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yylhs %slhs\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yylen %slen\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yydefred %sdefred\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yydgoto %sdgoto\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yysindex %ssindex\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyrindex %srindex\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yygindex %sgindex\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yytable %stable\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yycheck %scheck\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyname %sname\n", symbol_prefix);
        outline += 1;
        _ = fprintf(code_file, "#define yyrule %srule\n", symbol_prefix);
    }
    outline += 1;
    _ = fprintf(code_file, "#define YYPREFIX \"%s\"\n", symbol_prefix);
}
pub export fn output_rule_data() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    _ = fprintf(output_file, "const short %slhs[] =\n\t{%42d,", symbol_prefix, @as(c_int, @bitCast(@as(c_int, (blk: {
    ...
    j = 10;
    {
        ...
        while (i < nrules) : (i += 1) {
            ...
            _ = fprintf(output_file, "%5d,", @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = (blk_1: {
                    const tmp_2 = i;
    ...
    _ = fprintf(output_file, "\n};\n");
    _ = fprintf(output_file, "const short %slen[] =\n\t{%42d,", symbol_prefix, @as(c_int, 2));
    j = 10;
    {
        i = 3;
        while (i < nrules) : (i += 1) {
...
pub export fn output_yydefred() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    _ = fprintf(output_file, "const short %sdefred[] =\n\t{%39d,", symbol_prefix, if (@as(c_int, @bitCast(@as(c_int, defred[@as(c_uint, @intCast(@as(c_int, 0)))]))) != 0) @as(c_int, @bitCast(@as(c_int, defred[@as(c_uint, @intCast(@as(c_int, 0)))]))) - @as(c_int, 2) else @as(c_int, 0));
    j = 10;
    {
        i = 1;
        while (i < nstates) : (i += 1) {
            ...
            _ = fprintf(output_file, "%5d,", if (@as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk defred + @as(usize, @intCast(tmp)) else break :blk defred - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) != 0) @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk defred + @as(usize, @intCast(tmp)) else break :blk defred - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) - @as(c_int, 2) else @as(c_int, 0));
        }
    }
    if (!(rflag != 0)) {
        outline += @as(c_int, 2);
...
pub export fn output_actions() void {
    nvectors = (@as(c_int, 2) * nstates) + nvars;
    froms = @as([*c][*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nvectors))) *% @sizeOf([*c]c_short)))));
    tos = @as([*c][*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nvectors))) *% @sizeOf([*c]c_short)))));
    tally = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nvectors))) *% @sizeOf(c_short)))));
    width = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nvectors))) *% @sizeOf(c_short)))));
    token_actions();
    free(@as(?*anyopaque, @ptrCast(lookaheads)));
    free(@as(?*anyopaque, @ptrCast(LA)));
    free(@as(?*anyopaque, @ptrCast(LAruleno)));
    free(@as(?*anyopaque, @ptrCast(accessing_symbol)));
    goto_actions();
    free(@as(?*anyopaque, @ptrCast(goto_map + @as(usize, @bitCast(@as(isize, @intCast(ntokens)))))));
    free(@as(?*anyopaque, @ptrCast(from_state)));
    free(@as(?*anyopaque, @ptrCast(to_state)));
    sort_actions();
    pack_table();
    output_base();
    output_table();
...
pub export fn token_actions() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    var shiftcount: c_int = undefined;
    var reducecount: c_int = undefined;
    var max: c_int = undefined;
    var min: c_int = undefined;
    var actionrow: [*c]c_short = undefined;
    var r: [*c]c_short = undefined;
    var s: [*c]c_short = undefined;
    var p: [*c]action = undefined;
    actionrow = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 2) * ntokens))) *% @sizeOf(c_short)))));
    {
        i = 0;
        while (i < nstates) : (i += 1) {
            if ((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk parser + @as(usize, @intCast(tmp)) else break :blk parser - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* != null) {
                {
                    j = 0;
                    while (j < (@as(c_int, 2) * ntokens)) : (j += 1) {
                        (blk: {
                            const tmp = j;
                            if (tmp >= 0) break :blk actionrow + @as(usize, @intCast(tmp)) else break :blk actionrow - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = 0;
                    }
                }
                shiftcount = 0;
                reducecount = 0;
                {
                    ...
                    while (p != null) : (p = p.*.next) {
                        if (@as(c_int, @bitCast(@as(c_uint, p.*.suppressed))) == @as(c_int, 0)) {
                            if (@as(c_int, @bitCast(@as(c_uint, p.*.action_code))) == @as(c_int, 1)) {
                                shiftcount += 1;
                                (blk: {
                                    const tmp = p.*.symbol;
                                    if (tmp >= 0) break :blk actionrow + @as(usize, @intCast(tmp)) else break :blk actionrow - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                }).* = p.*.number;
                            } else if ((@as(c_int, @bitCast(@as(c_uint, p.*.action_code))) == @as(c_int, 2)) and (@as(c_int, @bitCast(@as(c_int, p.*.number))) != @as(c_int, @bitCast(@as(c_int, (blk: {
                                const tmp = i;
                                if (tmp >= 0) break :blk defred + @as(usize, @intCast(tmp)) else break :blk defred - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*))))) {
                                reducecount += 1;
                                (blk: {
                                    const tmp = @as(c_int, @bitCast(@as(c_int, p.*.symbol))) + ntokens;
                                    if (tmp >= 0) break :blk actionrow + @as(usize, @intCast(tmp)) else break :blk actionrow - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                }).* = p.*.number;
                            }
                        }
                ...
                (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk tally + @as(usize, @intCast(tmp)) else break :blk tally - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as(c_short, @bitCast(@as(c_short, @truncate(shiftcount))));
                (blk: {
                    const tmp = nstates + i;
                    if (tmp >= 0) break :blk tally + @as(usize, @intCast(tmp)) else break :blk tally - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as(c_short, @bitCast(@as(c_short, @truncate(reducecount))));
                (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk width + @as(usize, @intCast(tmp)) else break :blk width - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = 0;
                (blk: {
                    const tmp = nstates + i;
                    if (tmp >= 0) break :blk width + @as(usize, @intCast(tmp)) else break :blk width - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = 0;
                if (shiftcount > @as(c_int, 0)) {
                    (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk froms + @as(usize, @intCast(tmp)) else break :blk froms - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = blk: {
                        const tmp = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, shiftcount))) *% @sizeOf(c_short)))));
                        r = tmp;
                        break :blk tmp;
                    };
                    (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk tos + @as(usize, @intCast(tmp)) else break :blk tos - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = blk: {
                        const tmp = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, shiftcount))) *% @sizeOf(c_short)))));
                        s = tmp;
                        break :blk tmp;
                    ...
                    max = 0;
                    {
                        ...
                        while (j < ntokens) : (j += 1) {
                            if ((blk: {
                                ...
                                if (min > @as(c_int, @bitCast(@as(c_int, (blk: {
                                    const tmp = j;
                                    if (tmp >= 0) break :blk symbol_value + @as(usize, @intCast(tmp)) else break :blk symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                }).*)))) {
                                    min = @as(c_int, @bitCast(@as(c_int, (blk: {
                                        const tmp = j;
                                        if (tmp >= 0) break :blk symbol_value + @as(usize, @intCast(tmp)) else break :blk symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                    }).*)));
                                }
                                if (max < @as(c_int, @bitCast(@as(c_int, (blk: {
                                    const tmp = j;
                                    if (tmp >= 0) break :blk symbol_value + @as(usize, @intCast(tmp)) else break :blk symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                }).*)))) {
                                    max = @as(c_int, @bitCast(@as(c_int, (blk: {
                                        const tmp = j;
                                        if (tmp >= 0) break :blk symbol_value + @as(usize, @intCast(tmp)) else break :blk symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                    }).*)));
                                }
                    ...
                    (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk width + @as(usize, @intCast(tmp)) else break :blk width - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = @as(c_short, @bitCast(@as(c_short, @truncate((max - min) + @as(c_int, 1)))));
                }
                if (reducecount > @as(c_int, 0)) {
                    (blk: {
                        const tmp = nstates + i;
                        if (tmp >= 0) break :blk froms + @as(usize, @intCast(tmp)) else break :blk froms - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = blk: {
                        const tmp = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, reducecount))) *% @sizeOf(c_short)))));
                        r = tmp;
                        break :blk tmp;
                    };
                    (blk: {
                        ...
                        while (j < ntokens) : (j += 1) {
                            if ((blk: {
                                ...
                                (blk: {
                                    ...
                                    ref.* += 1;
                                    break :blk tmp;
                                }).* = @as(c_short, @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_int, (blk: {
                                    const tmp = ntokens + j;
                                    if (tmp >= 0) break :blk actionrow + @as(usize, @intCast(tmp)) else break :blk actionrow - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                }).*))) - @as(c_int, 2)))));
                            }
    ...
    free(@as(?*anyopaque, @ptrCast(actionrow)));
}
pub export fn goto_actions() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    var k: c_int = undefined;
    state_count = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nstates))) *% @sizeOf(c_short)))));
    k = default_goto(start_symbol + @as(c_int, 1));
    _ = fprintf(output_file, "const short %sdgoto[] =\n\t{%40d,", symbol_prefix, k);
    save_column(start_symbol + @as(c_int, 1), k);
    j = 10;
    {
        i = start_symbol + @as(c_int, 2);
        while (i < nsyms) : (i += 1) {
            if (j >= @as(c_int, 10)) {
                if (!(rflag != 0)) {
                    outline += 1;
    ...
    _ = fprintf(output_file, "\n};\n");
    free(@as(?*anyopaque, @ptrCast(state_count)));
}
pub export fn default_goto(arg_symbol: c_int) c_int {
    var symbol = arg_symbol;
    var i: c_int = undefined;
    var m: c_int = undefined;
    var n: c_int = undefined;
    var default_state: c_int = undefined;
    var max: c_int = undefined;
    m = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = symbol;
        if (tmp >= 0) break :blk goto_map + @as(usize, @intCast(tmp)) else break :blk goto_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
    n = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = symbol + @as(c_int, 1);
        if (tmp >= 0) break :blk goto_map + @as(usize, @intCast(tmp)) else break :blk goto_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
    if (m == n) return @as(c_int, 0);
    _ = memset(@as(?*anyopaque, @ptrCast(state_count)), @as(c_int, 0), @as(c_ulong, @bitCast(@as(c_long, nstates))) *% @sizeOf(c_short));
    {
        i = m;
        while (i < n) : (i += 1) {
            (blk: {
                const tmp = (blk_1: {
                    const tmp_2 = i;
                    if (tmp_2 >= 0) break :blk_1 to_state + @as(usize, @intCast(tmp_2)) else break :blk_1 to_state - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                }).*;
                if (tmp >= 0) break :blk state_count + @as(usize, @intCast(tmp)) else break :blk state_count - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* += 1;
        }
    }
    max = 0;
...
pub export fn save_column(arg_symbol: c_int, arg_default_state: c_int) void {
    var symbol = arg_symbol;
    var default_state = arg_default_state;
    var i: c_int = undefined;
    var m: c_int = undefined;
    var n: c_int = undefined;
    var sp: [*c]c_short = undefined;
    var sp1: [*c]c_short = undefined;
    var sp2: [*c]c_short = undefined;
    var count: c_int = undefined;
    var symno: c_int = undefined;
    m = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = symbol;
        if (tmp >= 0) break :blk goto_map + @as(usize, @intCast(tmp)) else break :blk goto_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
    ...
    count = 0;
    {
        ...
        while (i < n) : (i += 1) {
            if (@as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk to_state + @as(usize, @intCast(tmp)) else break :blk to_state - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) != default_state) {
                count += 1;
            }
        }
    }
    if (count == @as(c_int, 0)) return;
    symno = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = symbol;
        if (tmp >= 0) break :blk symbol_value + @as(usize, @intCast(tmp)) else break :blk symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) + (@as(c_int, 2) * nstates);
    (blk: {
        ...
        const tmp = blk_1: {
            const tmp_2 = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, count))) *% @sizeOf(c_short)))));
            sp = tmp_2;
            break :blk_1 tmp_2;
        };
        sp1 = tmp;
    ...
    (blk: {
        ...
        const tmp = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, count))) *% @sizeOf(c_short)))));
        sp2 = tmp;
        break :blk tmp;
    };
    {
        ...
        while (i < n) : (i += 1) {
            if (@as(c_int, @bitCast(@as(c_int, (blk: {
                ...
                (blk: {
                    ...
                    const tmp = i;
                    if (tmp >= 0) break :blk from_state + @as(usize, @intCast(tmp)) else break :blk from_state - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*;
                (blk: {
                    const ref = &sp2;
                    const tmp = ref.*;
    ...
    (blk: {
        const tmp = symno;
        if (tmp >= 0) break :blk tally + @as(usize, @intCast(tmp)) else break :blk tally - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = @as(c_short, @bitCast(@as(c_short, @truncate(count))));
    (blk: {
        const tmp = symno;
        if (tmp >= 0) break :blk width + @as(usize, @intCast(tmp)) else break :blk width - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = @as(c_short, @bitCast(@as(c_short, @truncate((@as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = -@as(c_int, 1);
        if (tmp >= 0) break :blk sp1 + @as(usize, @intCast(tmp)) else break :blk sp1 - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) - @as(c_int, @bitCast(@as(c_int, sp[@as(c_uint, @intCast(@as(c_int, 0)))])))) + @as(c_int, 1)))));
}
pub export fn sort_actions() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    var k: c_int = undefined;
    var t: c_int = undefined;
    var w: c_int = undefined;
    order = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nvectors))) *% @sizeOf(c_short)))));
    nentries = 0;
    {
        i = 0;
        while (i < nvectors) : (i += 1) {
            if (@as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk tally + @as(usize, @intCast(tmp)) else break :blk tally - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) > @as(c_int, 0)) {
                t = @as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk tally + @as(usize, @intCast(tmp)) else break :blk tally - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)));
                w = @as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk width + @as(usize, @intCast(tmp)) else break :blk width - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)));
                j = nentries - @as(c_int, 1);
                while ((j >= @as(c_int, 0)) and (@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = (blk_1: {
                        const tmp_2 = j;
                        if (tmp_2 >= 0) break :blk_1 order + @as(usize, @intCast(tmp_2)) else break :blk_1 order - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                    }).*;
                    if (tmp >= 0) break :blk width + @as(usize, @intCast(tmp)) else break :blk width - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) < w)) {
                    j -= 1;
                ...
                while (((j >= @as(c_int, 0)) and (@as(c_int, @bitCast(@as(c_int, (blk: {
                    ...
                    if (tmp >= 0) break :blk width + @as(usize, @intCast(tmp)) else break :blk width - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) == w)) and (@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = (blk_1: {
                        const tmp_2 = j;
                        if (tmp_2 >= 0) break :blk_1 order + @as(usize, @intCast(tmp_2)) else break :blk_1 order - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                    }).*;
                ...
                {
                    k = nentries - @as(c_int, 1);
                    while (k > j) : (k -= 1) {
                        (blk: {
                            const tmp = k + @as(c_int, 1);
                            if (tmp >= 0) break :blk order + @as(usize, @intCast(tmp)) else break :blk order - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = (blk: {
                            const tmp = k;
                            if (tmp >= 0) break :blk order + @as(usize, @intCast(tmp)) else break :blk order - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*;
...
pub export fn pack_table() void {
    var i: c_int = undefined;
    var place: c_int = undefined;
    var state: c_int = undefined;
    base = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nvectors))) *% @sizeOf(c_short)))));
    pos = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nentries))) *% @sizeOf(c_short)))));
    maxtable = 1000;
    table = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, maxtable))) *% @sizeOf(c_short)))));
    check = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, maxtable))) *% @sizeOf(c_short)))));
    lowzero = 0;
    high = 0;
    {
        i = 0;
        while (i < maxtable) : (i += 1) {
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk check + @as(usize, @intCast(tmp)) else break :blk check - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as(c_short, @bitCast(@as(c_short, @truncate(-@as(c_int, 1)))));
        }
    }
    {
        i = 0;
        while (i < nentries) : (i += 1) {
            state = matching_vector(i);
            if (state < @as(c_int, 0)) {
                place = pack_vector(i);
            } else {
                place = @as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = state;
                    if (tmp >= 0) break :blk base + @as(usize, @intCast(tmp)) else break :blk base - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)));
            }
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk pos + @as(usize, @intCast(tmp)) else break :blk pos - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as(c_short, @bitCast(@as(c_short, @truncate(place))));
            (blk: {
                const tmp = (blk_1: {
                    const tmp_2 = i;
                    if (tmp_2 >= 0) break :blk_1 order + @as(usize, @intCast(tmp_2)) else break :blk_1 order - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
    ...
    free(@as(?*anyopaque, @ptrCast(froms)));
    free(@as(?*anyopaque, @ptrCast(tos)));
    free(@as(?*anyopaque, @ptrCast(pos)));
}
pub export fn matching_vector(arg_vector: c_int) c_int {
    ...
    i = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = vector;
        if (tmp >= 0) break :blk order + @as(usize, @intCast(tmp)) else break :blk order - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
    if (i >= (@as(c_int, 2) * nstates)) return -@as(c_int, 1);
    t = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = i;
        if (tmp >= 0) break :blk tally + @as(usize, @intCast(tmp)) else break :blk tally - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
    ...
    {
        prev = vector - @as(c_int, 1);
        while (prev >= @as(c_int, 0)) : (prev -= 1) {
            j = @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = prev;
                if (tmp >= 0) break :blk order + @as(usize, @intCast(tmp)) else break :blk order - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)));
            if ((@as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = j;
                if (tmp >= 0) break :blk width + @as(usize, @intCast(tmp)) else break :blk width - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) != w) or (@as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = j;
                if (tmp >= 0) break :blk tally + @as(usize, @intCast(tmp)) else break :blk tally - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) != t)) return -@as(c_int, 1);
            match = 1;
            {
                k = 0;
                while ((match != 0) and (k < t)) : (k += 1) {
                    if ((@as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = k;
                        if (tmp >= 0) break :blk (blk_1: {
                            const tmp_2 = j;
                            if (tmp_2 >= 0) break :blk_1 tos + @as(usize, @intCast(tmp_2)) else break :blk_1 tos - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                    ...
                    }).*)))) or (@as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = k;
                        if (tmp >= 0) break :blk (blk_1: {
                            const tmp_2 = j;
                            if (tmp_2 >= 0) break :blk_1 froms + @as(usize, @intCast(tmp_2)) else break :blk_1 froms - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                        }).* + @as(usize, @intCast(tmp)) else break :blk (blk_1: {
                            const tmp_2 = j;
                            if (tmp_2 >= 0) break :blk_1 froms + @as(usize, @intCast(tmp_2)) else break :blk_1 froms - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                        }).* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
...
pub export fn pack_vector(arg_vector: c_int) c_int {
    var vector = arg_vector;
    var i: c_int = undefined;
    var j: c_int = undefined;
    var k: c_int = undefined;
    ...
    var t: c_int = undefined;
    var loc: c_int = undefined;
    var ok: c_int = undefined;
    var from: [*c]c_short = undefined;
    var to: [*c]c_short = undefined;
    var newmax: c_int = undefined;
    i = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = vector;
        if (tmp >= 0) break :blk order + @as(usize, @intCast(tmp)) else break :blk order - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (t != 0) {} else {
                __assert_fail("t", "yacc/output.c", @as(c_uint, @bitCast(@as(c_int, 588))), "int pack_vector(int)");
            };
        };
    };
    from = (blk: {
    ...
    j = lowzero - @as(c_int, @bitCast(@as(c_int, from[@as(c_uint, @intCast(@as(c_int, 0)))])));
    {
        k = 1;
        while (k < t) : (k += 1) if ((lowzero - @as(c_int, @bitCast(@as(c_int, (blk: {
            const tmp = k;
            if (tmp >= 0) break :blk from + @as(usize, @intCast(tmp)) else break :blk from - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*)))) > j) {
            j = lowzero - @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = k;
                if (tmp >= 0) break :blk from + @as(usize, @intCast(tmp)) else break :blk from - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)));
        };
    ...
    while (true) : (j += 1) {
        if (j == @as(c_int, 0)) continue;
        ok = 1;
        {
            k = 0;
            while ((ok != 0) and (k < t)) : (k += 1) {
                loc = j + @as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = k;
                    if (tmp >= 0) break :blk from + @as(usize, @intCast(tmp)) else break :blk from - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)));
                if (loc >= maxtable) {
                    if (loc >= @as(c_int, 32500)) {
                        fatal(@as([*c]u8, @ptrCast(@volatileCast(@constCast("maximum table size exceeded")))));
                    }
                    newmax = maxtable;
                    while (true) {
                        newmax += @as(c_int, 200);
                    ...
                    table = @as([*c]c_short, @ptrCast(@alignCast(realloc(@as(?*anyopaque, @ptrCast(table)), @as(c_ulong, @bitCast(@as(c_long, newmax))) *% @sizeOf(c_short)))));
                    if (table == @as([*c]c_short, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                        no_space();
                    }
                    check = @as([*c]c_short, @ptrCast(@alignCast(realloc(@as(?*anyopaque, @ptrCast(check)), @as(c_ulong, @bitCast(@as(c_long, newmax))) *% @sizeOf(c_short)))));
                    if (check == @as([*c]c_short, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                        no_space();
                    }
                    {
                        l = maxtable;
        ...
        if (ok != 0) {
            {
                ...
                while (k < t) : (k += 1) {
                    ...
                    (blk: {
                        ...
                        const tmp = k;
                        if (tmp >= 0) break :blk to + @as(usize, @intCast(tmp)) else break :blk to - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                    (blk: {
                        const tmp = loc;
                        if (tmp >= 0) break :blk check + @as(usize, @intCast(tmp)) else break :blk check - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            ...
            while ((lowzero < maxtable) and (@as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = lowzero;
                if (tmp >= 0) break :blk check + @as(usize, @intCast(tmp)) else break :blk check - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) != -@as(c_int, 1))) {
                lowzero += 1;
...
pub export fn output_base() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    _ = fprintf(output_file, "const short %ssindex[] =\n\t{%39d,", symbol_prefix, @as(c_int, @bitCast(@as(c_int, base[@as(c_uint, @intCast(@as(c_int, 0)))]))));
    j = 10;
    {
        i = 1;
        while (i < nstates) : (i += 1) {
    ...
    _ = fprintf(output_file, "};\nconst short %srindex[] =\n\t{%39d,", symbol_prefix, @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = nstates;
        if (tmp >= 0) break :blk base + @as(usize, @intCast(tmp)) else break :blk base - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))));
    j = 10;
    {
        i = nstates + @as(c_int, 1);
        while (i < (@as(c_int, 2) * nstates)) : (i += 1) {
            if (j >= @as(c_int, 10)) {
                if (!(rflag != 0)) {
                    outline += 1;
                }
    ...
    _ = fprintf(output_file, "};\nconst short %sgindex[] =\n\t{%39d,", symbol_prefix, @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = @as(c_int, 2) * nstates;
        if (tmp >= 0) break :blk base + @as(usize, @intCast(tmp)) else break :blk base - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))));
    j = 10;
    {
        i = (@as(c_int, 2) * nstates) + @as(c_int, 1);
        while (i < (nvectors - @as(c_int, 1))) : (i += 1) {
            if (j >= @as(c_int, 10)) {
                if (!(rflag != 0)) {
                    outline += 1;
                }
...
pub export fn output_table() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    outline += 1;
    _ = fprintf(code_file, "#define YYTABLESIZE %d\n", high);
    _ = fprintf(output_file, "const short %stable[] =\n\t{%40d,", symbol_prefix, @as(c_int, @bitCast(@as(c_int, table[@as(c_uint, @intCast(@as(c_int, 0)))]))));
    j = 10;
    {
        i = 1;
        while (i <= high) : (i += 1) {
    ...
    _ = fprintf(output_file, "\n};\n");
    free(@as(?*anyopaque, @ptrCast(table)));
}
pub export fn output_check() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    _ = fprintf(output_file, "const short %scheck[] =\n\t{%40d,", symbol_prefix, @as(c_int, @bitCast(@as(c_int, check[@as(c_uint, @intCast(@as(c_int, 0)))]))));
    j = 10;
    {
        i = 1;
        while (i <= high) : (i += 1) {
    ...
    _ = fprintf(output_file, "\n};\n");
    free(@as(?*anyopaque, @ptrCast(check)));
}
pub export fn is_C_identifier(arg_name: [*c]u8) c_int {
    var name = arg_name;
    var s: [*c]u8 = undefined;
    var c: c_int = undefined;
    s = name;
    c = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(s.*)))));
    if (c == @as(c_int, '"')) {
        ...
        }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISalpha)))))))) != 0) and (c != @as(c_int, '_'))) and (c != @as(c_int, '$'))) return @as(c_int, 0);
        while ((blk: {
            ...
            if ((!((@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = c;
                if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISalnum)))))))) != 0) and (c != @as(c_int, '_'))) and (c != @as(c_int, '$'))) return @as(c_int, 0);
        }
        return @as(c_int, 1);
    }
    if ((!((@as(c_int, @bitCast(@as(c_uint, (blk: {
...
pub export fn output_defines() void {
    var c: c_int = undefined;
    var i: c_int = undefined;
    var s: [*c]u8 = undefined;
    {
        ...
        while (i < ntokens) : (i += 1) {
            ...
            if (is_C_identifier(s) != 0) {
                _ = fprintf(code_file, "#define ");
                if (dflag != 0) {
                    _ = fprintf(defines_file, "#define ");
                }
                c = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(s.*)))));
                if (c == @as(c_int, '"')) {
                    while ((blk: {
                ...
                outline += 1;
                _ = fprintf(code_file, " %d\n", @as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk symbol_value + @as(usize, @intCast(tmp)) else break :blk symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))));
                if (dflag != 0) {
                    _ = fprintf(defines_file, " %d\n", @as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk symbol_value + @as(usize, @intCast(tmp)) else break :blk symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*))));
                }
    ...
    outline += 1;
    _ = fprintf(code_file, "#define YYERRCODE %d\n", @as(c_int, @bitCast(@as(c_int, symbol_value[@as(c_uint, @intCast(@as(c_int, 1)))]))));
    if ((@as(c_int, @bitCast(@as(c_uint, dflag))) != 0) and (@as(c_int, @bitCast(@as(c_uint, unionized))) != 0)) {
        rewind(union_file);
        while ((blk: {
            const tmp = getc(union_file);
            c = tmp;
            break :blk tmp;
        }) != -@as(c_int, 1)) {
            _ = putc(c, defines_file);
        }
        _ = fprintf(defines_file, " YYSTYPE;\n");
        _ = fprintf(defines_file, "#endif /* YYSTYPE_DEFINED */\n");
        _ = fprintf(defines_file, "extern YYSTYPE %slval;\n", symbol_prefix);
    }
}
pub export fn output_stored_text() void {
    var c: c_int = undefined;
    var in: [*c]FILE = undefined;
    var out: [*c]FILE = undefined;
    rewind(text_file);
    in = text_file;
    if ((blk: {
        const tmp = getc(in);
    ...
    if (!(lflag != 0)) {
        _ = fprintf(out, @as([*c]u8, @ptrCast(@alignCast(&line_format))), (blk: {
            const ref = &outline;
            ref.* += 1;
            break :blk ref.*;
        }) + @as(c_int, 1), code_file_name);
    }
}
pub export fn output_debug() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    var k: c_int = undefined;
    var max: c_int = undefined;
    var symnam: [*c][*c]u8 = undefined;
    var s: [*c]u8 = undefined;
    outline += 1;
    _ = fprintf(code_file, "#define YYFINAL %d\n", @as(c_int, @bitCast(@as(c_int, final_state))));
    outline += @as(c_int, 3);
    _ = fprintf(code_file, "#ifndef YYDEBUG\n#define YYDEBUG %d\n#endif\n", @as(c_int, @bitCast(@as(c_uint, tflag))));
    if (rflag != 0) {
        _ = fprintf(output_file, "#ifndef YYDEBUG\n#define YYDEBUG %d\n#endif\n", @as(c_int, @bitCast(@as(c_uint, tflag))));
    }
    max = 0;
    {
        i = 2;
        while (i < ntokens) : (i += 1) if (@as(c_int, @bitCast(@as(c_int, (blk: {
            const tmp = i;
            if (tmp >= 0) break :blk symbol_value + @as(usize, @intCast(tmp)) else break :blk symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*))) > max) {
            max = @as(c_int, @bitCast(@as(c_int, (blk: {
    ...
    outline += 1;
    _ = fprintf(code_file, "#define YYMAXTOKEN %d\n", max);
    symnam = @as([*c][*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, max + @as(c_int, 1)))), @sizeOf([*c]u8)))));
    if (symnam == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        no_space();
    }
    {
        i = ntokens - @as(c_int, 1);
        while (i >= @as(c_int, 2)) : (i -= 1) {
            (blk: {
                const tmp = (blk_1: {
                    const tmp_2 = i;
                    if (tmp_2 >= 0) break :blk_1 symbol_value + @as(usize, @intCast(tmp_2)) else break :blk_1 symbol_value - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                }).*;
                if (tmp >= 0) break :blk symnam + @as(usize, @intCast(tmp)) else break :blk symnam - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk symbol_name + @as(usize, @intCast(tmp)) else break :blk symbol_name - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
    ...
    symnam[@as(c_uint, @intCast(@as(c_int, 0)))] = "end-of-file";
    if (!(rflag != 0)) {
        outline += 1;
    }
    _ = fprintf(output_file, "#if YYDEBUG\nconst char * const %sname[] =\n\t{", symbol_prefix);
    j = 80;
    {
        i = 0;
        while (i <= max) : (i += 1) {
            if ((blk: {
                const tmp = (blk_1: {
                    const tmp_2 = i;
                    if (tmp_2 >= 0) break :blk_1 symnam + @as(usize, @intCast(tmp_2)) else break :blk_1 symnam - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                }).*;
                s = tmp;
                break :blk tmp;
                ...
                if (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '"')) {
                    ...
                    while (@as(c_int, @bitCast(@as(c_uint, (blk: {
                        ...
                        if (@as(c_int, @bitCast(@as(c_uint, s.*))) == @as(c_int, '\\')) {
                            ...
                            if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                                ...
                                _ = putc(@as(c_int, @bitCast(@as(c_uint, s.*))), output_file);
                            }
                        } else {
                            _ = putc(@as(c_int, @bitCast(@as(c_uint, s.*))), output_file);
                        }
                    ...
                    _ = fprintf(output_file, "\\\"\",");
                } else if (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\'')) {
                    ...
                    k = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(s) +% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 3))))))));
                    j += k;
                    if (j > @as(c_int, 80)) {
                        if (!(rflag != 0)) {
                            outline += 1;
    ...
    _ = fprintf(output_file, "\n};\n");
    free(@as(?*anyopaque, @ptrCast(symnam)));
    if (!(rflag != 0)) {
        outline += 1;
    }
    _ = fprintf(output_file, "const char * const %srule[] =\n\t{", symbol_prefix);
    {
        i = 2;
        while (i < nrules) : (i += 1) {
            _ = fprintf(output_file, "\"%s :", (blk: {
                const tmp = (blk_1: {
                    const tmp_2 = i;
                    if (tmp_2 >= 0) break :blk_1 rlhs + @as(usize, @intCast(tmp_2)) else break :blk_1 rlhs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                }).*;
                ...
                while (@as(c_int, @bitCast(@as(c_int, (blk: {
                    ...
                    if (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '"')) {
                        ...
                        while (@as(c_int, @bitCast(@as(c_uint, (blk: {
                            ...
                            if (@as(c_int, @bitCast(@as(c_uint, s.*))) == @as(c_int, '\\')) {
                                if (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 1)))]))) == @as(c_int, '\\')) {
                                    ...
                                    _ = fprintf(output_file, "\\\\%c", @as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 1)))]))));
                                }
                                s += 1;
                            } else {
                                _ = putc(@as(c_int, @bitCast(@as(c_uint, s.*))), output_file);
                        ...
                        if (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 1)))]))) == @as(c_int, '"')) {
                            ...
                            if (@as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 2)))]))) == @as(c_int, '\\')) {
                                _ = fprintf(output_file, " '\\\\\\\\");
                            } else {
                                _ = fprintf(output_file, " '\\\\%c", @as(c_int, @bitCast(@as(c_uint, s[@as(c_uint, @intCast(@as(c_int, 2)))]))));
                            }
...
pub export fn output_stype() void {
    if (!(unionized != 0) and (ntags == @as(c_int, 0))) {
        outline += @as(c_int, 3);
        _ = fprintf(code_file, "#ifndef YYSTYPE\ntypedef int YYSTYPE;\n#endif\n");
    }
}
pub export fn output_trailing_text() void {
    var c: c_int = undefined;
    ...
    if (c == @as(c_int, '\n')) {
        ...
        if (!(lflag != 0)) {
            outline += 1;
            _ = fprintf(out, @as([*c]u8, @ptrCast(@alignCast(&line_format))), lineno, input_file_name);
        }
        if (c == @as(c_int, '\n')) {
            outline += 1;
        }
...
pub export fn output_semantic_actions() void {
    var c: c_int = undefined;
    var last: c_int = undefined;
    var out: [*c]FILE = undefined;
    rewind(action_file);
    if ((blk: {
        const tmp = getc(action_file);
        c = tmp;
        break :blk tmp;
    }) == -@as(c_int, 1)) return;
    out = code_file;
...
pub export fn free_itemsets() void {
    var cp: [*c]core = undefined;
    var next: [*c]core = undefined;
    free(@as(?*anyopaque, @ptrCast(state_table)));
    {
        cp = first_state;
        while (cp != null) : (cp = next) {
            next = cp.*.next;
            free(@as(?*anyopaque, @ptrCast(cp)));
        }
    }
}
pub export fn free_shifts() void {
    var sp: [*c]shifts = undefined;
    var next: [*c]shifts = undefined;
    free(@as(?*anyopaque, @ptrCast(shift_table)));
    {
        sp = first_shift;
        while (sp != null) : (sp = next) {
            next = sp.*.next;
            free(@as(?*anyopaque, @ptrCast(sp)));
        }
    }
}
pub export fn free_reductions() void {
    var rp: [*c]reductions = undefined;
    var next: [*c]reductions = undefined;
    free(@as(?*anyopaque, @ptrCast(reduction_table)));
    {
        rp = first_reduction;
