...
pub export fn lalr() void {
    tokensetsize = @divTrunc(ntokens + (@as(c_int, 32) - @as(c_int, 1)), @as(c_int, 32));
    set_state_table();
...
pub const struct_shorts = extern struct {
    next: [*c]struct_shorts,
    value: c_short,
};
pub const shorts = struct_shorts;
pub export var tokensetsize: c_int = @import("std").mem.zeroes(c_int);
pub export fn transpose(arg_old_R: [*c][*c]c_short, arg_n: c_int) [*c][*c]c_short {
    var old_R = arg_old_R;
    var n = arg_n;
    var new_R: [*c][*c]c_short = undefined;
    var temp_R: [*c][*c]c_short = undefined;
    var nedges: [*c]c_short = undefined;
    var sp: [*c]c_short = undefined;
    var i: c_int = undefined;
    var k: c_int = undefined;
    nedges = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf(c_short)))));
    {
        i = 0;
        while (i < n) : (i += 1) {
            sp = (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk old_R + @as(usize, @intCast(tmp)) else break :blk old_R - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            if (sp != null) {
                while (@as(c_int, @bitCast(@as(c_int, sp.*))) >= @as(c_int, 0)) {
                    (blk: {
                        const tmp = (blk_1: {
                            const ref = &sp;
                            const tmp_2 = ref.*;
                        ...
                        if (tmp >= 0) break :blk nedges + @as(usize, @intCast(tmp)) else break :blk nedges - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* += 1;
                }
            }
        }
    }
    new_R = @as([*c][*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf([*c]c_short)))));
    temp_R = @as([*c][*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, n))) *% @sizeOf([*c]c_short)))));
    {
        i = 0;
        while (i < n) : (i += 1) {
            ...
            if (k > @as(c_int, 0)) {
                sp = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, k + @as(c_int, 1)))) *% @sizeOf(c_short)))));
                (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk new_R + @as(usize, @intCast(tmp)) else break :blk new_R - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = sp;
                (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk temp_R + @as(usize, @intCast(tmp)) else break :blk temp_R - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = sp;
                (blk: {
                    const tmp = k;
                    if (tmp >= 0) break :blk sp + @as(usize, @intCast(tmp)) else break :blk sp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as(c_short, @bitCast(@as(c_short, @truncate(-@as(c_int, 1)))));
            }
        }
    }
    free(@as(?*anyopaque, @ptrCast(nedges)));
    {
        i = 0;
        while (i < n) : (i += 1) {
            sp = (blk: {
                ...
                while (@as(c_int, @bitCast(@as(c_int, sp.*))) >= @as(c_int, 0)) {
                    (blk: {
                        const ref = &(blk_1: {
                            ...
                            if (tmp_2 >= 0) break :blk_1 temp_R + @as(usize, @intCast(tmp_2)) else break :blk_1 temp_R - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                        }).*;
                        const tmp = ref.*;
                        ref.* += 1;
                        break :blk tmp;
    ...
    free(@as(?*anyopaque, @ptrCast(temp_R)));
    return new_R;
}
pub export fn set_state_table() void {
    var sp: [*c]core = undefined;
    state_table = @as([*c][*c]core, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nstates))) *% @sizeOf([*c]core)))));
    {
        sp = first_state;
        while (sp != null) : (sp = sp.*.next) {
            (blk: {
                const tmp = sp.*.number;
                if (tmp >= 0) break :blk state_table + @as(usize, @intCast(tmp)) else break :blk state_table - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = sp;
        }
    }
}
pub export fn set_accessing_symbol() void {
    var sp: [*c]core = undefined;
    accessing_symbol = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nstates))) *% @sizeOf(c_short)))));
    {
        sp = first_state;
        while (sp != null) : (sp = sp.*.next) {
            (blk: {
                const tmp = sp.*.number;
                if (tmp >= 0) break :blk accessing_symbol + @as(usize, @intCast(tmp)) else break :blk accessing_symbol - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = sp.*.accessing_symbol;
        }
    }
}
pub export fn set_shift_table() void {
    var sp: [*c]shifts = undefined;
    shift_table = @as([*c][*c]shifts, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nstates))) *% @sizeOf([*c]shifts)))));
    {
        sp = first_shift;
        while (sp != null) : (sp = sp.*.next) {
            (blk: {
                const tmp = sp.*.number;
                if (tmp >= 0) break :blk shift_table + @as(usize, @intCast(tmp)) else break :blk shift_table - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = sp;
        }
    }
}
pub export fn set_reduction_table() void {
    var rp: [*c]reductions = undefined;
    reduction_table = @as([*c][*c]reductions, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nstates))) *% @sizeOf([*c]reductions)))));
    {
        rp = first_reduction;
        while (rp != null) : (rp = rp.*.next) {
            (blk: {
                const tmp = rp.*.number;
                if (tmp >= 0) break :blk reduction_table + @as(usize, @intCast(tmp)) else break :blk reduction_table - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = rp;
        }
    }
}
pub export fn set_maxrhs() void {
    var itemp: [*c]c_short = undefined;
    var item_end: [*c]c_short = undefined;
    var length: c_int = undefined;
    var max: c_int = undefined;
    length = 0;
    max = 0;
    item_end = ritem + @as(usize, @bitCast(@as(isize, @intCast(nitems))));
    {
        itemp = ritem;
        while (itemp < item_end) : (itemp += 1) {
            if (@as(c_int, @bitCast(@as(c_int, itemp.*))) >= @as(c_int, 0)) {
                length += 1;
            } else {
                if (length > max) {
                    max = length;
...
pub export fn initialize_LA() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    var k: c_int = undefined;
    var rp: [*c]reductions = undefined;
    lookaheads = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nstates + @as(c_int, 1)))) *% @sizeOf(c_short)))));
    k = 0;
    {
        i = 0;
        while (i < nstates) : (i += 1) {
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk lookaheads + @as(usize, @intCast(tmp)) else break :blk lookaheads - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as(c_short, @bitCast(@as(c_short, @truncate(k))));
            rp = (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk reduction_table + @as(usize, @intCast(tmp)) else break :blk reduction_table - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            if (rp != null) {
                k += @as(c_int, @bitCast(@as(c_int, rp.*.nreds)));
            }
        }
    }
    (blk: {
    ...
    LA = @as([*c]c_uint, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, k * tokensetsize))) *% @sizeOf(c_uint)))));
    LAruleno = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, k))) *% @sizeOf(c_short)))));
    lookback = @as([*c][*c]shorts, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, k))) *% @sizeOf([*c]shorts)))));
    k = 0;
    {
        i = 0;
        while (i < nstates) : (i += 1) {
            ...
            if (rp != null) {
                {
                    j = 0;
                    while (j < @as(c_int, @bitCast(@as(c_int, rp.*.nreds)))) : (j += 1) {
                        (blk: {
                            const tmp = k;
                            if (tmp >= 0) break :blk LAruleno + @as(usize, @intCast(tmp)) else break :blk LAruleno - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = rp.*.rules[@as(c_uint, @intCast(j))];
                        k += 1;
                    }
                }
            }
...
pub export fn set_goto_map() void {
    var sp: [*c]shifts = undefined;
    var i: c_int = undefined;
    var k: c_int = undefined;
    var symbol: c_int = undefined;
    var state1: c_int = undefined;
    var state2: c_int = undefined;
    var temp_map: [*c]c_short = undefined;
    goto_map = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nvars + @as(c_int, 1)))) *% @sizeOf(c_short))))) - @as(usize, @bitCast(@as(isize, @intCast(ntokens))));
    temp_map = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nvars + @as(c_int, 1)))) *% @sizeOf(c_short))))) - @as(usize, @bitCast(@as(isize, @intCast(ntokens))));
    ngotos = 0;
    {
        sp = first_shift;
        while (sp != null) : (sp = sp.*.next) {
            {
                i = @as(c_int, @bitCast(@as(c_int, sp.*.nshifts))) - @as(c_int, 1);
                while (i >= @as(c_int, 0)) : (i -= 1) {
                    symbol = @as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = sp.*.shift[@as(c_uint, @intCast(i))];
                        if (tmp >= 0) break :blk accessing_symbol + @as(usize, @intCast(tmp)) else break :blk accessing_symbol - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*)));
                    if (symbol < start_symbol) break;
                    if (ngotos == @as(c_int, 32767)) {
                        fatal(@as([*c]u8, @ptrCast(@volatileCast(@constCast("too many gotos")))));
                    }
                    ngotos += 1;
                    (blk: {
                        const tmp = symbol;
    ...
    k = 0;
    {
        ...
        while (i < nsyms) : (i += 1) {
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk temp_map + @as(usize, @intCast(tmp)) else break :blk temp_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as(c_short, @bitCast(@as(c_short, @truncate(k))));
            k += @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk goto_map + @as(usize, @intCast(tmp)) else break :blk goto_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    ...
    (blk: {
        const tmp = nsyms;
        if (tmp >= 0) break :blk goto_map + @as(usize, @intCast(tmp)) else break :blk goto_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = @as(c_short, @bitCast(@as(c_short, @truncate(ngotos))));
    (blk: {
        const tmp = nsyms;
        if (tmp >= 0) break :blk temp_map + @as(usize, @intCast(tmp)) else break :blk temp_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = @as(c_short, @bitCast(@as(c_short, @truncate(ngotos))));
    from_state = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, ngotos))) *% @sizeOf(c_short)))));
    to_state = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, ngotos))) *% @sizeOf(c_short)))));
    {
        sp = first_shift;
        while (sp != null) : (sp = sp.*.next) {
            state1 = @as(c_int, @bitCast(@as(c_int, sp.*.number)));
            {
                i = @as(c_int, @bitCast(@as(c_int, sp.*.nshifts))) - @as(c_int, 1);
                while (i >= @as(c_int, 0)) : (i -= 1) {
                    state2 = @as(c_int, @bitCast(@as(c_int, sp.*.shift[@as(c_uint, @intCast(i))])));
                    symbol = @as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = state2;
                        if (tmp >= 0) break :blk accessing_symbol + @as(usize, @intCast(tmp)) else break :blk accessing_symbol - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*)));
                    ...
                    k = @as(c_int, @bitCast(@as(c_int, blk: {
                        const ref = &(blk_1: {
                            const tmp_2 = symbol;
                            if (tmp_2 >= 0) break :blk_1 temp_map + @as(usize, @intCast(tmp_2)) else break :blk_1 temp_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
                        }).*;
                        const tmp = ref.*;
                        ref.* += 1;
                        break :blk tmp;
                    ...
                    }).* = @as(c_short, @bitCast(@as(c_short, @truncate(state1))));
                    (blk: {
                        const tmp = k;
                        if (tmp >= 0) break :blk to_state + @as(usize, @intCast(tmp)) else break :blk to_state - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = @as(c_short, @bitCast(@as(c_short, @truncate(state2))));
                }
            }
        }
    }
    free(@as(?*anyopaque, @ptrCast(temp_map + @as(usize, @bitCast(@as(isize, @intCast(ntokens)))))));
}
pub export fn initialize_F() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    var k: c_int = undefined;
    var sp: [*c]shifts = undefined;
    var edge: [*c]c_short = undefined;
    var rp: [*c]c_short = undefined;
    var reads: [*c][*c]c_short = undefined;
    var rowp: [*c]c_uint = undefined;
    var nedges: c_int = undefined;
    var stateno: c_int = undefined;
    var symbol: c_int = undefined;
    var nwords: c_int = undefined;
    nwords = ngotos * tokensetsize;
    F = @as([*c]c_uint, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nwords))) *% @sizeOf(c_uint)))));
    reads = @as([*c][*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, ngotos))) *% @sizeOf([*c]c_short)))));
    edge = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, ngotos + @as(c_int, 1)))) *% @sizeOf(c_short)))));
    nedges = 0;
    rowp = F;
    {
        i = 0;
        while (i < ngotos) : (i += 1) {
            stateno = @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk to_state + @as(usize, @intCast(tmp)) else break :blk to_state - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)));
            sp = (blk: {
            ...
            if (sp != null) {
                k = @as(c_int, @bitCast(@as(c_int, sp.*.nshifts)));
                {
                    j = 0;
                    while (j < k) : (j += 1) {
                        symbol = @as(c_int, @bitCast(@as(c_int, (blk: {
                            const tmp = sp.*.shift[@as(c_uint, @intCast(j))];
                            if (tmp >= 0) break :blk accessing_symbol + @as(usize, @intCast(tmp)) else break :blk accessing_symbol - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*)));
                        if (symbol >= start_symbol) break;
                        _ = blk: {
                            const ref = &(blk_1: {
                                const tmp = symbol >> @intCast(5);
                                if (tmp >= 0) break :blk_1 rowp + @as(usize, @intCast(tmp)) else break :blk_1 rowp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*;
                            ref.* |= @as(c_uint, @bitCast(@as(c_int, 1))) << @intCast(symbol & @as(c_int, 31));
                            break :blk ref.*;
                        };
                    }
                }
                while (j < k) : (j += 1) {
                    ...
                    if ((blk: {
                        const tmp = symbol;
                        if (tmp >= 0) break :blk nullable + @as(usize, @intCast(tmp)) else break :blk nullable - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* != 0) {
                        (blk: {
                            const tmp = blk_1: {
                                const ref = &nedges;
                            ...
                            if (tmp >= 0) break :blk edge + @as(usize, @intCast(tmp)) else break :blk edge - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = @as(c_short, @bitCast(@as(c_short, @truncate(map_goto(stateno, symbol)))));
                    }
                }
                if (nedges != 0) {
                    (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk reads + @as(usize, @intCast(tmp)) else break :blk reads - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = blk: {
                        const tmp = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nedges + @as(c_int, 1)))) *% @sizeOf(c_short)))));
                        rp = tmp;
                        break :blk tmp;
                    };
                    {
                        ...
                        while (j < nedges) : (j += 1) {
                            (blk: {
                                const tmp = j;
                                if (tmp >= 0) break :blk rp + @as(usize, @intCast(tmp)) else break :blk rp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).* = (blk: {
                                const tmp = j;
                                if (tmp >= 0) break :blk edge + @as(usize, @intCast(tmp)) else break :blk edge - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*;
            ...
            rowp += @as(usize, @bitCast(@as(isize, @intCast(tokensetsize))));
        }
    }
    _ = blk: {
        const ref = &(blk_1: {
            const tmp = @as(c_int, 0) >> @intCast(5);
            if (tmp >= 0) break :blk_1 F + @as(usize, @intCast(tmp)) else break :blk_1 F - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*;
        ref.* |= @as(c_uint, @bitCast(@as(c_int, 1))) << @intCast(@as(c_int, 0) & @as(c_int, 31));
        break :blk ref.*;
    };
    digraph(reads);
    {
    ...
    free(@as(?*anyopaque, @ptrCast(reads)));
    free(@as(?*anyopaque, @ptrCast(edge)));
}
pub export fn build_relations() void {
    var i: c_int = undefined;
    var j: c_int = undefined;
    var k: c_int = undefined;
    var rulep: [*c]c_short = undefined;
    var rp: [*c]c_short = undefined;
    var sp: [*c]shifts = undefined;
    var length: c_int = undefined;
    var nedges: c_int = undefined;
    ...
    var state1: c_int = undefined;
    var stateno: c_int = undefined;
    var symbol1: c_int = undefined;
    var symbol2: c_int = undefined;
    var shortp: [*c]c_short = undefined;
    var edge: [*c]c_short = undefined;
    var states: [*c]c_short = undefined;
    var new_includes: [*c][*c]c_short = undefined;
    includes = @as([*c][*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, ngotos))) *% @sizeOf([*c]c_short)))));
    edge = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, ngotos + @as(c_int, 1)))) *% @sizeOf(c_short)))));
    states = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, maxrhs + @as(c_int, 1)))) *% @sizeOf(c_short)))));
    {
        i = 0;
        while (i < ngotos) : (i += 1) {
            nedges = 0;
            state1 = @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk from_state + @as(usize, @intCast(tmp)) else break :blk from_state - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)));
            symbol1 = @as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = (blk_1: {
                    const tmp_2 = i;
            ...
            }).*)));
            {
                rulep = (blk: {
                    const tmp = symbol1;
                    if (tmp >= 0) break :blk derives + @as(usize, @intCast(tmp)) else break :blk derives - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*;
                while (@as(c_int, @bitCast(@as(c_int, rulep.*))) >= @as(c_int, 0)) : (rulep += 1) {
                    length = 1;
                    states[@as(c_uint, @intCast(@as(c_int, 0)))] = @as(c_short, @bitCast(@as(c_short, @truncate(state1))));
                    stateno = state1;
                    {
                        rp = ritem + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, @bitCast(@as(c_int, (blk: {
                            const tmp = rulep.*;
                            if (tmp >= 0) break :blk rrhs + @as(usize, @intCast(tmp)) else break :blk rrhs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*)))))));
                        while (@as(c_int, @bitCast(@as(c_int, rp.*))) >= @as(c_int, 0)) : (rp += 1) {
                            symbol2 = @as(c_int, @bitCast(@as(c_int, rp.*)));
                            sp = (blk: {
                                const tmp = stateno;
                                if (tmp >= 0) break :blk shift_table + @as(usize, @intCast(tmp)) else break :blk shift_table - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*;
                            k = @as(c_int, @bitCast(@as(c_int, sp.*.nshifts)));
                            {
                                j = 0;
                                while (j < k) : (j += 1) {
                                    stateno = @as(c_int, @bitCast(@as(c_int, sp.*.shift[@as(c_uint, @intCast(j))])));
                            ...
                            (blk: {
                                ...
                                if (tmp >= 0) break :blk states + @as(usize, @intCast(tmp)) else break :blk states - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).* = @as(c_short, @bitCast(@as(c_short, @truncate(stateno))));
                        }
                    }
                    add_lookback_edge(stateno, @as(c_int, @bitCast(@as(c_int, rulep.*))), i);
                    length -= 1;
                    done = 0;
                    while (!(done != 0)) {
                        done = 1;
                        rp -= 1;
                        if (@as(c_int, @bitCast(@as(c_int, rp.*))) >= start_symbol) {
                            stateno = @as(c_int, @bitCast(@as(c_int, (blk: {
                                const tmp = blk_1: {
                                    const ref = &length;
                                    ref.* -= 1;
                            ...
                            (blk: {
                                ...
                                if (tmp >= 0) break :blk edge + @as(usize, @intCast(tmp)) else break :blk edge - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).* = @as(c_short, @bitCast(@as(c_short, @truncate(map_goto(stateno, @as(c_int, @bitCast(@as(c_int, rp.*))))))));
                            if ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                                const tmp = rp.*;
                                if (tmp >= 0) break :blk nullable + @as(usize, @intCast(tmp)) else break :blk nullable - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*))) != 0) and (length > @as(c_int, 0))) {
                                done = 0;
                            }
                        }
                    }
            ...
            if (nedges != 0) {
                (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk includes + @as(usize, @intCast(tmp)) else break :blk includes - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = blk: {
                    const tmp = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, nedges + @as(c_int, 1)))) *% @sizeOf(c_short)))));
                    shortp = tmp;
                    break :blk tmp;
                };
                {
                    ...
                    while (j < nedges) : (j += 1) {
                        (blk: {
                            const tmp = j;
                            if (tmp >= 0) break :blk shortp + @as(usize, @intCast(tmp)) else break :blk shortp - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).* = (blk: {
                            const tmp = j;
                            if (tmp >= 0) break :blk edge + @as(usize, @intCast(tmp)) else break :blk edge - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*;
    ...
    free(@as(?*anyopaque, @ptrCast(includes)));
    includes = new_includes;
    free(@as(?*anyopaque, @ptrCast(edge)));
    free(@as(?*anyopaque, @ptrCast(states)));
}
pub export fn compute_FOLLOWS() void {
    digraph(includes);
}
pub export fn compute_lookaheads() void {
    var i: c_int = undefined;
    var n: c_int = undefined;
    var fp1: [*c]c_uint = undefined;
    var fp2: [*c]c_uint = undefined;
    var fp3: [*c]c_uint = undefined;
    var sp: [*c]shorts = undefined;
    var next: [*c]shorts = undefined;
    var rowp: [*c]c_uint = undefined;
    rowp = LA;
    ...
    }).*)));
    {
        i = 0;
        while (i < n) : (i += 1) {
            fp3 = rowp + @as(usize, @bitCast(@as(isize, @intCast(tokensetsize))));
            {
                sp = (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk lookback + @as(usize, @intCast(tmp)) else break :blk lookback - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*;
                while (sp != null) : (sp = sp.*.next) {
                    fp1 = rowp;
                    fp2 = F + @as(usize, @bitCast(@as(isize, @intCast(tokensetsize * @as(c_int, @bitCast(@as(c_int, sp.*.value)))))));
                    while (fp1 < fp3) {
                        (blk: {
                            const ref = &fp1;
                            const tmp = ref.*;
    ...
    free(@as(?*anyopaque, @ptrCast(lookback)));
    free(@as(?*anyopaque, @ptrCast(F)));
}
pub export fn map_goto(arg_state: c_int, arg_symbol: c_int) c_int {
    var state = arg_state;
    var symbol = arg_symbol;
    var high: c_int = undefined;
    var low: c_int = undefined;
    var middle: c_int = undefined;
    var s: c_int = undefined;
    low = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = symbol;
        if (tmp >= 0) break :blk goto_map + @as(usize, @intCast(tmp)) else break :blk goto_map - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
    high = @as(c_int, @bitCast(@as(c_int, (blk: {
    ...
    while (true) {
        _ = blk: {
            _ = @sizeOf(c_int);
            break :blk blk_1: {
                break :blk_1 if (low <= high) {} else {
                    __assert_fail("low <= high", "yacc/lalr.c", @as(c_uint, @bitCast(@as(c_int, 274))), "int map_goto(int, int)");
                };
            };
        };
        middle = (low + high) >> @intCast(1);
        s = @as(c_int, @bitCast(@as(c_int, (blk: {
            const tmp = middle;
            if (tmp >= 0) break :blk from_state + @as(usize, @intCast(tmp)) else break :blk from_state - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*)));
        if (s == state) return middle else if (s < state) {
            low = middle + @as(c_int, 1);
        } else {
            high = middle - @as(c_int, 1);
        }
    }
    return 0;
}
pub export fn digraph(arg_relation: [*c][*c]c_short) void {
    var relation = arg_relation;
    var i: c_int = undefined;
    infinity = ngotos + @as(c_int, 2);
    INDEX = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, ngotos + @as(c_int, 1)))) *% @sizeOf(c_short)))));
    VERTICES = @as([*c]c_short, @ptrCast(@alignCast(allocate(@as(c_ulong, @bitCast(@as(c_long, ngotos + @as(c_int, 1)))) *% @sizeOf(c_short)))));
    top = 0;
    R = relation;
    _ = memset(@as(?*anyopaque, @ptrCast(INDEX)), @as(c_int, 0), @as(c_ulong, @bitCast(@as(c_long, ngotos))) *% @sizeOf(c_short));
    {
        i = 0;
        while (i < ngotos) : (i += 1) if ((blk: {
            const tmp = i;
    ...
    free(@as(?*anyopaque, @ptrCast(INDEX)));
    free(@as(?*anyopaque, @ptrCast(VERTICES)));
}
pub export fn add_lookback_edge(arg_stateno: c_int, arg_ruleno: c_int, arg_gotono: c_int) void {
    var stateno = arg_stateno;
    var ruleno = arg_ruleno;
    var gotono = arg_gotono;
    var i: c_int = undefined;
    var k: c_int = undefined;
    ...
    k = @as(c_int, @bitCast(@as(c_int, (blk: {
        const tmp = stateno + @as(c_int, 1);
        if (tmp >= 0) break :blk lookaheads + @as(usize, @intCast(tmp)) else break :blk lookaheads - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*)));
    found = 0;
    while (!(found != 0) and (i < k)) {
        if (@as(c_int, @bitCast(@as(c_int, (blk: {
            const tmp = i;
            if (tmp >= 0) break :blk LAruleno + @as(usize, @intCast(tmp)) else break :blk LAruleno - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*))) == ruleno) {
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (found != 0) {} else {
                __assert_fail("found", "yacc/lalr.c", @as(c_uint, @bitCast(@as(c_int, 440))), "void add_lookback_edge(int, int, int)");
            };
        };
    };
    sp = @as([*c]shorts, @ptrCast(@alignCast(allocate(@sizeOf(shorts)))));
    sp.*.next = (blk: {
        const tmp = i;
        if (tmp >= 0) break :blk lookback + @as(usize, @intCast(tmp)) else break :blk lookback - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*;
    sp.*.value = @as(c_short, @bitCast(@as(c_short, @truncate(gotono))));
    (blk: {
        const tmp = i;
        if (tmp >= 0) break :blk lookback + @as(usize, @intCast(tmp)) else break :blk lookback - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = sp;
}
pub export fn traverse(arg_i: c_int) void {
    var i = arg_i;
    var base: [*c]c_uint = undefined;
    var fp1: [*c]c_uint = undefined;
    var fp2: [*c]c_uint = undefined;
    var fp3: [*c]c_uint = undefined;
    var j: c_int = undefined;
    ...
    (blk: {
        const tmp = i;
        if (tmp >= 0) break :blk INDEX + @as(usize, @intCast(tmp)) else break :blk INDEX - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = @as(c_short, @bitCast(@as(c_short, @truncate(blk: {
        const tmp = top;
        height = tmp;
        break :blk tmp;
    }))));
    base = F + @as(usize, @bitCast(@as(isize, @intCast(i * tokensetsize))));
    fp3 = base + @as(usize, @bitCast(@as(isize, @intCast(tokensetsize))));
    rp = (blk: {
        const tmp = i;
        if (tmp >= 0) break :blk R + @as(usize, @intCast(tmp)) else break :blk R - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*;
    if (rp != null) {
        while ((blk: {
            ...
            fp1 = base;
            fp2 = F + @as(usize, @bitCast(@as(isize, @intCast(j * tokensetsize))));
            while (fp1 < fp3) {
                (blk: {
                    const ref = &fp1;
                    const tmp = ref.*;
    ...
    if (@as(c_int, @bitCast(@as(c_int, (blk: {
        ...
        while (true) {
            ...
            (blk: {
                const tmp = j;
                if (tmp >= 0) break :blk INDEX + @as(usize, @intCast(tmp)) else break :blk INDEX - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as(c_short, @bitCast(@as(c_short, @truncate(infinity))));
            if (i == j) break;
            fp1 = base;
            fp2 = F + @as(usize, @bitCast(@as(isize, @intCast(j * tokensetsize))));
            while (fp1 < fp3) {
...
pub var infinity: c_int = @import("std").mem.zeroes(c_int);
pub var maxrhs: c_int = @import("std").mem.zeroes(c_int);
pub var ngotos: c_int = @import("std").mem.zeroes(c_int);
pub var F: [*c]c_uint = @import("std").mem.zeroes([*c]c_uint);
pub var includes: [*c][*c]c_short = @import("std").mem.zeroes([*c][*c]c_short);
pub var lookback: [*c][*c]shorts = @import("std").mem.zeroes([*c][*c]shorts);
pub var R: [*c][*c]c_short = @import("std").mem.zeroes([*c][*c]c_short);
pub var INDEX: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var VERTICES: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub var top: c_int = @import("std").mem.zeroes(c_int);
