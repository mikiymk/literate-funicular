...
pub export fn verbose() void {
    var i: c_int = undefined;
    if (!(vflag != 0)) return;
    null_rules = @as([*c]c_short, @ptrCast(@alignCast(reallocarray(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(usize, @bitCast(@as(c_long, nrules))), @sizeOf(c_short)))));
    if (null_rules == @as([*c]c_short, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        no_space();
    }
    _ = fprintf(verbose_file, "\x0c\n");
    {
        i = 0;
        while (i < nstates) : (i += 1) {
            print_state(i);
    ...
    free(@as(?*anyopaque, @ptrCast(null_rules)));
    if (nunused != 0) {
        log_unused();
    }
    if ((SRtotal != 0) or (RRtotal != 0)) {
        log_conflicts();
    }
    _ = fprintf(verbose_file, "\n\n%d terminals, %d nonterminals\n", ntokens, nvars);
    _ = fprintf(verbose_file, "%d grammar rules, %d states\n", nrules - @as(c_int, 2), nstates);
}
...
pub var null_rules: [*c]c_short = @import("std").mem.zeroes([*c]c_short);
pub export fn log_unused() void {
    var i: c_int = undefined;
    var p: [*c]c_short = undefined;
    _ = fprintf(verbose_file, "\n\nRules never reduced:\n");
    {
        i = 3;
        while (i < nrules) : (i += 1) {
            if (!((blk: {
                ...
                {
                    p = ritem + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk rrhs + @as(usize, @intCast(tmp)) else break :blk rrhs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*)))))));
                    while (@as(c_int, @bitCast(@as(c_int, p.*))) >= @as(c_int, 0)) : (p += 1) {
                        _ = fprintf(verbose_file, " %s", (blk: {
                            const tmp = p.*;
                            if (tmp >= 0) break :blk symbol_name + @as(usize, @intCast(tmp)) else break :blk symbol_name - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*);
                ...
                _ = fprintf(verbose_file, "  (%d)\n", i - @as(c_int, 2));
            }
        }
    }
}
pub export fn log_conflicts() void {
    var i: c_int = undefined;
    _ = fprintf(verbose_file, "\n\n");
    {
        i = 0;
        while (i < nstates) : (i += 1) {
            if ((@as(c_int, @bitCast(@as(c_int, (blk: {
            ...
            }).*))) != 0) or (@as(c_int, @bitCast(@as(c_int, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk RRconflicts + @as(usize, @intCast(tmp)) else break :blk RRconflicts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) != 0)) {
                _ = fprintf(verbose_file, "State %d contains ", i);
                if (@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk SRconflicts + @as(usize, @intCast(tmp)) else break :blk SRconflicts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) == @as(c_int, 1)) {
                    _ = fprintf(verbose_file, "1 shift/reduce conflict");
                } else if (@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk SRconflicts + @as(usize, @intCast(tmp)) else break :blk SRconflicts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) > @as(c_int, 1)) {
                    _ = fprintf(verbose_file, "%d shift/reduce conflicts", @as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk SRconflicts + @as(usize, @intCast(tmp)) else break :blk SRconflicts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*))));
                }
                if ((@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk SRconflicts + @as(usize, @intCast(tmp)) else break :blk SRconflicts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) != 0) and (@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk RRconflicts + @as(usize, @intCast(tmp)) else break :blk RRconflicts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) != 0)) {
                    _ = fprintf(verbose_file, ", ");
                ...
                if (@as(c_int, @bitCast(@as(c_int, (blk: {
                    ...
                    _ = fprintf(verbose_file, "1 reduce/reduce conflict");
                } else if (@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk RRconflicts + @as(usize, @intCast(tmp)) else break :blk RRconflicts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) > @as(c_int, 1)) {
                    _ = fprintf(verbose_file, "%d reduce/reduce conflicts", @as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk RRconflicts + @as(usize, @intCast(tmp)) else break :blk RRconflicts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*))));
                }
...
pub export fn print_state(arg_state: c_int) void {
    var state = arg_state;
    if (state != 0) {
        _ = fprintf(verbose_file, "\n\n");
    }
    ...
    _ = fprintf(verbose_file, "state %d\n", state);
    print_core(state);
    print_nulls(state);
    print_actions(state);
}
pub export fn print_conflicts(arg_state: c_int) void {
    var state = arg_state;
    ...
    symbol = -@as(c_int, 1);
    {
        ...
        while (p != null) : (p = p.*.next) {
            if (@as(c_int, @bitCast(@as(c_uint, p.*.suppressed))) == @as(c_int, 2)) continue;
            if (@as(c_int, @bitCast(@as(c_int, p.*.symbol))) != symbol) {
                symbol = @as(c_int, @bitCast(@as(c_int, p.*.symbol)));
                number = @as(c_int, @bitCast(@as(c_int, p.*.number)));
                if (@as(c_int, @bitCast(@as(c_uint, p.*.action_code))) == @as(c_int, 1)) {
                    act = 1;
                } else {
                    act = 2;
                }
            } else if (@as(c_int, @bitCast(@as(c_uint, p.*.suppressed))) == @as(c_int, 1)) {
                if ((state == @as(c_int, @bitCast(@as(c_int, final_state)))) and (symbol == @as(c_int, 0))) {
                    _ = fprintf(verbose_file, "%d: shift/reduce conflict (accept, reduce %d) on $end\n", state, @as(c_int, @bitCast(@as(c_int, p.*.number))) - @as(c_int, 2));
                } else {
                    if (act == @as(c_int, 1)) {
                        _ = fprintf(verbose_file, "%d: shift/reduce conflict (shift %d, reduce %d) on %s\n", state, number, @as(c_int, @bitCast(@as(c_int, p.*.number))) - @as(c_int, 2), (blk: {
                            const tmp = symbol;
                            if (tmp >= 0) break :blk symbol_name + @as(usize, @intCast(tmp)) else break :blk symbol_name - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*);
                    } else {
                        _ = fprintf(verbose_file, "%d: reduce/reduce conflict (reduce %d, reduce %d) on %s\n", state, number - @as(c_int, 2), @as(c_int, @bitCast(@as(c_int, p.*.number))) - @as(c_int, 2), (blk: {
                            const tmp = symbol;
                            if (tmp >= 0) break :blk symbol_name + @as(usize, @intCast(tmp)) else break :blk symbol_name - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*);
                    }
...
pub export fn print_core(arg_state: c_int) void {
    var state = arg_state;
    var i: c_int = undefined;
    var k: c_int = undefined;
    var rule: c_int = undefined;
    var statep: [*c]core = undefined;
    ...
    k = @as(c_int, @bitCast(@as(c_int, statep.*.nitems)));
    {
        i = 0;
        while (i < k) : (i += 1) {
            sp1 = blk: {
                const tmp = ritem + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, @bitCast(@as(c_int, statep.*.items[@as(c_uint, @intCast(i))])))))));
                sp = tmp;
                break :blk tmp;
            };
            ...
            rule = -@as(c_int, @bitCast(@as(c_int, sp.*)));
            _ = fprintf(verbose_file, "\t%s : ", (blk: {
                const tmp = (blk_1: {
                    const tmp_2 = rule;
                    if (tmp_2 >= 0) break :blk_1 rlhs + @as(usize, @intCast(tmp_2)) else break :blk_1 rlhs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_2)) +% -1));
            ...
            {
                sp = ritem + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = rule;
                    if (tmp >= 0) break :blk rrhs + @as(usize, @intCast(tmp)) else break :blk rrhs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)))))));
                while (sp < sp1) : (sp += 1) {
            ...
            _ = fprintf(verbose_file, "  (%d)\n", -@as(c_int, 2) - @as(c_int, @bitCast(@as(c_int, sp.*))));
        }
    }
}
pub export fn print_nulls(arg_state: c_int) void {
    var state = arg_state;
    var p: [*c]action = undefined;
    var i: c_int = undefined;
    var j: c_int = undefined;
    var k: c_int = undefined;
    var nnulls: c_int = undefined;
    nnulls = 0;
    {
        p = (blk: {
            const tmp = state;
        ...
        while (p != null) : (p = p.*.next) {
            if ((@as(c_int, @bitCast(@as(c_uint, p.*.action_code))) == @as(c_int, 2)) and ((@as(c_int, @bitCast(@as(c_uint, p.*.suppressed))) == @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, p.*.suppressed))) == @as(c_int, 1)))) {
                i = @as(c_int, @bitCast(@as(c_int, p.*.number)));
                if ((@as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk rrhs + @as(usize, @intCast(tmp)) else break :blk rrhs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) + @as(c_int, 1)) == @as(c_int, @bitCast(@as(c_int, (blk: {
                    const tmp = i + @as(c_int, 1);
                    if (tmp >= 0) break :blk rrhs + @as(usize, @intCast(tmp)) else break :blk rrhs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)))) {
                    {
                        j = 0;
                        while ((j < nnulls) and (i > @as(c_int, @bitCast(@as(c_int, (blk: {
                            const tmp = j;
                            if (tmp >= 0) break :blk null_rules + @as(usize, @intCast(tmp)) else break :blk null_rules - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*))))) : (j += 1) continue;
                    }
                    if (j == nnulls) {
                        nnulls += 1;
                    ...
                    } else if (i != @as(c_int, @bitCast(@as(c_int, (blk: {
                        const tmp = j;
                        if (tmp >= 0) break :blk null_rules + @as(usize, @intCast(tmp)) else break :blk null_rules - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*)))) {
                        nnulls += 1;
...
pub export fn print_actions(arg_stateno: c_int) void {
    var stateno = arg_stateno;
    var p: [*c]action = undefined;
    var sp: [*c]shifts = undefined;
    var as: c_int = undefined;
    if (stateno == @as(c_int, @bitCast(@as(c_int, final_state)))) {
        _ = fprintf(verbose_file, "\t$end  accept\n");
    }
    p = (blk: {
        const tmp = stateno;
        if (tmp >= 0) break :blk parser + @as(usize, @intCast(tmp)) else break :blk parser - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    ...
    if (p != null) {
        print_shifts(p);
        print_reductions(p, @as(c_int, @bitCast(@as(c_int, (blk: {
            const tmp = stateno;
    ...
    if ((sp != null) and (@as(c_int, @bitCast(@as(c_int, sp.*.nshifts))) > @as(c_int, 0))) {
        as = @as(c_int, @bitCast(@as(c_int, (blk: {
            const tmp = sp.*.shift[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_int, sp.*.nshifts))) - @as(c_int, 1)))];
...
pub export fn print_shifts(arg_p: [*c]action) void {
    var p = arg_p;
    ...
    count = 0;
    {
        ...
        while (q != null) : (q = q.*.next) {
            if ((@as(c_int, @bitCast(@as(c_uint, q.*.suppressed))) < @as(c_int, 2)) and (@as(c_int, @bitCast(@as(c_uint, q.*.action_code))) == @as(c_int, 1))) {
                count += 1;
            }
        }
    }
    if (count > @as(c_int, 0)) {
        while (p != null) : (p = p.*.next) {
            if ((@as(c_int, @bitCast(@as(c_uint, p.*.action_code))) == @as(c_int, 1)) and (@as(c_int, @bitCast(@as(c_uint, p.*.suppressed))) == @as(c_int, 0))) {
                _ = fprintf(verbose_file, "\t%s  shift %d\n", (blk: {
                    const tmp = p.*.symbol;
                    if (tmp >= 0) break :blk symbol_name + @as(usize, @intCast(tmp)) else break :blk symbol_name - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, @as(c_int, @bitCast(@as(c_int, p.*.number))));
            }
        }
    }
}
pub export fn print_reductions(arg_p: [*c]action, arg_pdefred: c_int) void {
    var p = arg_p;
    var pdefred = arg_pdefred;
    var k: c_int = undefined;
    var anyreds: c_int = undefined;
    var q: [*c]action = undefined;
    anyreds = 0;
    {
        q = p;
        while (q != null) : (q = q.*.next) {
            if ((@as(c_int, @bitCast(@as(c_uint, q.*.action_code))) == @as(c_int, 2)) and (@as(c_int, @bitCast(@as(c_uint, q.*.suppressed))) < @as(c_int, 2))) {
                anyreds = 1;
                break;
            }
        }
    }
    if (anyreds == @as(c_int, 0)) {
        _ = fprintf(verbose_file, "\t.  error\n");
    } else {
        while (p != null) : (p = p.*.next) {
            if ((@as(c_int, @bitCast(@as(c_uint, p.*.action_code))) == @as(c_int, 2)) and (@as(c_int, @bitCast(@as(c_int, p.*.number))) != pdefred)) {
                k = @as(c_int, @bitCast(@as(c_int, p.*.number))) - @as(c_int, 2);
                if (@as(c_int, @bitCast(@as(c_uint, p.*.suppressed))) == @as(c_int, 0)) {
                    _ = fprintf(verbose_file, "\t%s  reduce %d\n", (blk: {
                        const tmp = p.*.symbol;
                        if (tmp >= 0) break :blk symbol_name + @as(usize, @intCast(tmp)) else break :blk symbol_name - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*, k);
                }
        ...
        if (pdefred > @as(c_int, 0)) {
            _ = fprintf(verbose_file, "\t.  reduce %d\n", pdefred - @as(c_int, 2));
        }
    }
}
pub export fn print_gotos(arg_stateno: c_int) void {
    var stateno = arg_stateno;
    var i: c_int = undefined;
    var k: c_int = undefined;
    var as: c_int = undefined;
    ...
    {
        i = 0;
        while (i < @as(c_int, @bitCast(@as(c_int, sp.*.nshifts)))) : (i += 1) {
            ...
            if (as >= start_symbol) {
                _ = fprintf(verbose_file, "\t%s  goto %d\n", (blk: {
                    const tmp = as;
                    if (tmp >= 0) break :blk symbol_name + @as(usize, @intCast(tmp)) else break :blk symbol_name - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, k);
            }
